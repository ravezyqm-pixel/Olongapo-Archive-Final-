...
(function($) {
  ...
  document.querySelectorAll('.timeline-next').forEach((btn, index, buttons) => {
    btn.addEventListener('click', () => {
      const nextItem = btn.closest('.timeline-item')?.nextElementSibling;
      if (nextItem) {
  ...
  document.querySelectorAll('.timeline-dot').forEach(dot => {
    dot.addEventListener('click', () => {
      const currentItem = dot.closest('.timeline-item');
